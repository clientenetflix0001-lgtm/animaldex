...
export interface ApiNotification {
  id: string;
  type: 'like' | 'comment' | 'follow_user' | 'follow_pet' | 'location' | 'birthday' | 'reel_like' | 'reel_comment' | 'pet_transfer_requested' | 'pet_transfer_accepted' | 'pet_transfer_rejected' | 'listing_comment';
  actorId: string | null;
  actorName: string;
